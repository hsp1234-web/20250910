...
# ║                                                                      ║
# ║ - V43 更新日誌 (2025-09-30):                                         ║
# ║   - **緊急修復**: 新增 `weasyprint` 至核心依賴項，解決因缺少該套件  ║
# ║     而導致的 API 伺服器啟動失敗問題。                              ║
# ║ - V42 更新日誌 (2025-09-30):                                         ║
# ║   - **穩定性修復**: 還原 FRED 金鑰的處理邏輯，修復因非同步處理與   ║
# ║     依賴安裝之間的競爭條件所造成的啟動失敗問題。                   ║
# ║ - V41 更新日誌 (2025-09-30):                                         ║
# ║   - **緊急修復**: 新增 `fredapi` 至核心依賴項，解決因缺少該套件   ║
# ║     而導致的啟動失敗問題。                                         ║
# ║ - V40 更新日誌 (2025-09-30):                                         ║
...
#@title ✨🐺 善狼一鍵啟動器 (v43) - 終極簡化版 🐺 { vertical-output: true, display-mode: "form" }
#@markdown ---
#@markdown ### **核心設定**
