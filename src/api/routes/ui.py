...
@router.get("/bond-analysis-demo", response_class=HTMLResponse)
async def serve_bond_analysis_demo(request: Request):
    """ 提供債券分析功能的 Demo 頁面。 """
    return templates.TemplateResponse("bond_analysis_demo.html", {"request": request})
