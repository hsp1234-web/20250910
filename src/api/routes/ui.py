...
@router.get("/page11_summary_center", response_class=HTMLResponse)
async def serve_page11_summary_center(request: Request):
    """ 提供重點摘要中心頁面 """
    return templates.TemplateResponse("page11_summary_center.html", {"request": request})
