...
async def lifespan(app: FastAPI):
    ...
    # 4. 方案 G-2: 初始化並啟動金鑰生命週期管理器
    key_lifecycle_manager.load_keys_from_env()
    key_lifecycle_manager.start_validation_loop()
    app.state.key_lifecycle_manager = key_lifecycle_manager
    ...
    # 2. 停止金鑰管理器
    key_lifecycle_manager.stop_validation_loop()
