...
def main():
    ...
    try:
        ...
        api_stdout_thread = threading.Thread(target=stream_reader, args=(api_proc.stdout, 'api_server'), kwargs={'ready_event': api_ready_event, 'ready_signal': api_ready_signal})
