# services/bond_data_service/data_fetchers/fred_dgs5_fetcher.py
import pandas as pd
...
def fetch_dgs5_data(api_key: str, start_date: str, end_date: str) -> pd.Series:
    """
    使用 FRED API 獲取 5 年期美國公債固定期限利率 (DGS5) 在指定日期範圍內的資料，並存入資料庫。
    ...
    Returns:
        pd.Series: 包含 DGS5 資料的 pandas Series，索引為日期。
